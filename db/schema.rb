...
ActiveRecord::Schema.define(version: 20160527134344) do
  ...
  add_index "admin", ["email"], name: "index_admin_on_email", unique: true
  add_index "admin", ["reset_password_token"], name: "index_admin_on_reset_password_token", unique: true
